...
# Bot and owner info
OWNER_USERNAME = getenv("OWNER_USERNAME", "Tera_YaaaR_Hu")
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/A_Quotes_B")


YOUR_API_URL = getenv("YOUR_API_URL", "https://myloveisdimpi.online")
